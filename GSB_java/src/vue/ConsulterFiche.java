...
public class ConsulterFiche extends JPanel
{
	 ...
	 * Create the panel.
	 */
	public ConsulterFiche(JFrame myFrame)
	{
		setLayout(null);
		...
		table.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent me) {
				...
				if (me.getClickCount() == 2) {
					...
					ConsultModifVisiteur p1 = new ConsultModifVisiteur(utilisateurByRegion.get(row),false,regions);
		...
		buttonOkNp.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				//Create and populate the panel.
				ConsultModifVisiteur p1 = new ConsultModifVisiteur(utils.get(comboBoxNomPrenom.getSelectedIndex()),false,regions);
		...
		buttonOkId.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				//Create and populate the panel.
				ConsultModifVisiteur p1 = new ConsultModifVisiteur(utils.get(comboBoxIdentifiant.getSelectedIndex()),false,regions);
