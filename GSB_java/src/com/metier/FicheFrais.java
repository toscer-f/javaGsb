...
public class FicheFrais implements Serializable
{
     ...
     */
    public FicheFrais(String idUtilisateur,String mois,int nbJustificatifs, BigDecimal montant,Date dateModif,List<LigneFraisForfait> listeLigneFraisForfait,List<LigneFraisHorsForfait> listeLigneFraisHorsForfait,String idEtat)
    {
        super();
